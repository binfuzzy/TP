...
public class Ini {
	...
	/**
	 * List of section: para almacenar cada una de las entradas del fichero
	 */
	...
	public boolean equals(Object obj) {
		...
		for (int i = 0; i < this.getSections().size(); i++) {
			if (!this.getSections().get(i).equals(other.getSections().get(i))) {
				System.out.println("Alumnos: " + this.getSections().get(i));
				System.out.println("Profesores: " + other.getSections().get(i));
