...
import es.ucm.fdi.model.carreteras.CarreteraTipica;
import es.ucm.fdi.model.cruces.CruceGenerico;

public class EventoNuevaCarreteraTipica extends EventoNuevaCarretera{

	public EventoNuevaCarreteraTipica(int tiempo, String id, String origen, String destino, int velocidadMaxima, int longitud) {
	...
	protected Carretera creaCarretera(CruceGenerico<?> cruceOrigen, CruceGenerico<?> cruceDestino) {
		return new CarreteraTipica(this.id, this.longitud, this.velocidadMaxima, cruceOrigen, cruceDestino);
	}
